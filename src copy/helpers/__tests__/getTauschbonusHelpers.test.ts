...
describe('getTauschbonusHelpers', ()=>{
    ...
    describe('getIsTauschbonus', () => {
        it('should return false if no tauschbonus in storage', () => {
            (<jest.Mock>getSessionStorageItemJson).mockImplementation(() => null);
            const isTauschbonus = getIsTauschbonus();
            expect(isTauschbonus).toEqual(false);
        });
        ...
        it('should get tradeIn from storage', () => {
            ...
            const isTauschbonus = getIsTauschbonus();
            expect(isTauschbonus).toEqual(true);
        });
    });
