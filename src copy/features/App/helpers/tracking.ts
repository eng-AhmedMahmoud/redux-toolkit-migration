 ...
 * @todo the jest function for the createTrackingData function
 */
export function createTrackingData (state: RootState) {
    const trackingData = selectTrackingPayload(state);
    const trackingPayload = createPageViewTrackingData(trackingData);
