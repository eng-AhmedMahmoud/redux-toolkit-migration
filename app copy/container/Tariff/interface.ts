...
import { IInitialState as IInitialStateApp } from 'Container/App/interfaces/state';
 ...
 * Promotional Summary Card offer
 */
export interface PromotionalSummaryCardOfferInterface {
     /**
      * Offer Price
      */
...
/**
 * Data needed for initial state
 * @param activeSubscriptionId
 * @param tariffInformationSheet
 * @param highlightBadge
 */
export interface IInitialStatePriceSection {
    /**
     * activeSubscriptionId
     */
    activeSubscriptionId: number | boolean;
    /**
     * tariffInformationSheet
     */
    tariffInformationSheet: string | boolean;
    /**
     * highlightBadge
     */
    highlightBadge: object | boolean;
}
 ...
 */
export interface PromotionalCardCheckbox {
    /**
     * Label
     */
    txtLabelText: string;
 ...
 */
export interface PromotionalCardFlagBadge {
    /**
     * Label
     */
    stdLabel: string;
